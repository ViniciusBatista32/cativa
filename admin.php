	...
	<div class="row m-0 p-0 w-100 h-100">
		<div class="col-sm-5 marketing p-0">
			<div class="container text-center">
				...
				<img src="imagesimagem-admin1.jpg" class="imagem-marketing img-responsive">
			</div>
		</div>
		...
		<div class="col-sm-7 form-login">
			<form action="" class="w-50 mx-auto">
				...
				<div class="form-group escrita-baixa text-center mt-5">O login é apenas para administradores.</div>
			</form>
		</div>
	</div>
</body>
