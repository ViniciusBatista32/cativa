	...
	<div class="row">
		<div class="col">
			...
			<div class="row whatsapp-place p-4 m-0">
				...
				<div class="col text-center">
					<h5 class="title-footer">Whatsapp</h5>
			...
			<div class="row telefone-place p-4 mt-5 m-0">
				...
				<div class="col text-center">
					<h5 class="title-footer">Telefone Fixo</h5>
		...
		<div class="col-md-auto">
			<img id="contactImage" src="imagesimagem-contato.png" class="contato-imagem img-responsive">
		</div>
	</div>
</div>
