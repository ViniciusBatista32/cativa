...
<!-- Whatsapp Button -->
<a class="whatsappbutton rounded-circle" href="https://api.whatsapp.com/send?phone=<?php echo $whatsapp ?>">
	<i class="fab fa-whatsapp text-center h-100 w-100 fs-2"></i>
</a>
<!-- Whatsapp Button -->
			...
			<div class="row">
				<div class="owl-carousel owl-theme">
					<div class="item shadow">
						<div class="card">
							<a href="carro"><img src="images/Carros/img2.jpeg" alt="image" class="card-img-top"></a>
						</div>
					</div>
...
<a href="estoque" class="link-secondary" style="text-decoration: none;">
	<p class="fs-5 text-center mt-5 mb-5" style="letter-spacing: 1px;">VER ESTOQUE COMPLETO &#129321;</p>
</a>
